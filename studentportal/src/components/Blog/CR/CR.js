...
const CardOfCrBlog = ({ title, intro_para, author, posting_date, brief_info }) => {
	return (
	...
	return (
		<div className="Cr_blog container block ">
			<div className="heading_and_button">
				<h1 className="heading" style={{fontFamily: "Robot Slab"}}> By Class Representative <img style={{marginLeft: "5px"}} src={vector} alt="logo" /></h1>
				{/* Buttons Block */}
