      ...
      <>
        <Navbar collapseOnSelect expand="lg" bg="light" variant="light">
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav>
              <div>
                <Button variant="secondary" onClick={handleShowLogin} size="sm" className="ml-3 pl-3 pr-3">Log In</Button>
                ...
                {/* code for Sign up modal starts here */}
                  <Modal size="lg" centered show={show} onHide={handleClose}>
                        <div className="main_div">
                          <div className="disappear"><img className="for_img" src={signup_img} alt="signup " /></div>
                          <hr></hr>
                          <div className="container mt-4">
                            <Form className="form_css">
                              ...
                              <Form.Group controlId="formBasicEmail">
                                ...
                                <Form.Control type="email" className="border border-primary" placeholder="Enter email" />
                              </Form.Group>

                              <Form.Group controlId="formBasicEmail">
                                <Form.Label className="font-weight-bold">Username</Form.Label>
                                <Form.Control type="text"  className="border border-info" placeholder="Enter Username" />
                              </Form.Group>

                              <Form.Group controlId="formBasicPassword">
                                <Form.Label className="font-weight-bold">Password</Form.Label>
                                <Form.Control type="password" className="border border-primary" placeholder="Password" />
                              ...
                              <p className="text-center">Already have an account ? <button type="button" onClick={for_login_modal} className="btn btn-link">Login here</button></p>
                            </Form>
                          </div>
                        </div>
                      </Modal>
                {/* sign up modal code ends here */}
                  ...
                  <Modal  size="lg" centered show={showLogin} onHide={handleCloseLogin}>
                        <div className="main_div_login">
                          <div className="disappear_login"><img className="for_img_login" src={login_img} alt="login" /></div>
                          <hr></hr>
                          <div className="container mt-4">
                            <Form className="form_css_login">
                              ...
                              <Form.Group controlId="formBasicEmail">
                                <Form.Label className="font-weight-bold mt-2">Username</Form.Label>
                                <Form.Control type="text" className="mt-1  border border-primary" placeholder="Enter Username" />
                              </Form.Group>

                              <Form.Group controlId="formBasicPassword">
                                <Form.Label className="font-weight-bold mt-2">Password</Form.Label>
                                <Form.Control type="password" className="mt-1 border border-info" placeholder="Password" />

                              </Form.Group>
                              <Form.Group style={{display:"flex"}} controlId="formBasicCheckbox">
                                <Form.Check type="checkbox" className="txt_policy_conditions_login" label="Remember me" />
                                <Form.Label className="forgot-link"><button type="button" className="btn btn-link btn-forgot float-right"> Forgot Password ?</button></Form.Label>
